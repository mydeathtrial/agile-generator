<#if (doPackageName?? && doPackageName!="")>package ${doPackageName};
...
/**
<#if (remarks?? && remarks!="")> * 描述：${remarks}实体</#if>
*
...
public class ${doName} extends BaseEntity implements Serializable {
...
<#if haveEqualsAndHashCodeMethod>
    ...
    public boolean equals(Object o) {
        ...
        ${doName} that = (${doName}) o;
        return <#list columns as property>Objects.equals(${property.javaName}, that.${property.javaName})<#if !property_has_next>; <#else>
                && </#if></#list>
    }
